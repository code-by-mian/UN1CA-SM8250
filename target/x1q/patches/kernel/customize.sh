...
BOOT_PARTS="$SRC_DIR/prebuilts/kernels/x1q/boot.img.part*"
BOOT_FULL="$SRC_DIR/prebuilts/kernels/x1q/boot.img"
...
if [ -f "$SRC_DIR/prebuilts/kernels/x1q/dtbo.img" ]; then
    cp -fa "$SRC_DIR/prebuilts/kernels/x1q/dtbo.img" "$WORK_DIR/kernel/"
